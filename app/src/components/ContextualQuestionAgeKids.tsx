...
export const ContextualQuestionAgeKids: React.FC<ContextualQuestionProps> = (
  ...
  const { setFieldValue, values } = useFormikContext<{ kidsDetails: Array<{ name: string; age: string; gender: string }> }>();
          ...
          <View className="flex-1 bg-black/50 items-center justify-center">
            <View className="w-11/12 bg-white p-6 rounded-lg">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setKidInfo({ ...kidInfo, gender: text })
                }
              />
              <Button
                onPress={() => {
